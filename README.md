...
| `-hf_upload_checkpoint_only` | bool | `False` | no | Upload only the run-1 checkpoint for each sampling seed and suppress result-folder uploads. `-hf_upload_model_config_only` is a compatibility alias. |
